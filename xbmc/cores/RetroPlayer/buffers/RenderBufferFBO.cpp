...
{
  CLog::Log(LOGDEBUG, "RetroPlayer[RENDER]: update FBO buffer: {} tex_id: {} rbo_id: {}",
            fmt::ptr(this), m_tex_id, m_rbo_id);
...
{
  CLog::Log(LOGERROR, "RetroPlayer[RENDER]: fbo_id: {}", m_fbo_id);
