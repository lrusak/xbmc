...
class CZeroconfService : public INetworkService, public ISettingCallback
{
public:
  CZeroconfService();
  virtual ~CZeroconfService() override = default;
  ...
  std::string Name() override { return "zeroconf"; }
  void Start() override;
