...
public:
  ...
  /*!
   ...
   \sa CJobManager and CJob
   */
  virtual void OnJobComplete(unsigned int jobID, bool success, IJob* job) = 0;
  ...
  /*!
   ...
   \sa CJobManager and CJob
   */
  virtual void OnJobAbort(unsigned int jobID, IJob* job) {}
...
enum class JobPriority
{
  ...
  NORMAL,
  HIGH,
  DEDICATED, // will create a new worker if no worker is available at queue time
};
